...
const CountryOfOriginsPage: NextPage = () => {
  // ? useSession
  ...
  // ? useQuery
  const { data, isLoading } = api.countryOfOrigin.getAll.useQuery(variables, {
    enabled: !!session
  })
      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            ...
            dataIndex: 'name',
            render: (name, record) => (
              <Link href={`/country-of-origins/${record.id}`}>
        ...
        dataSource={data?.countryOfOrigins}
        rowKey="id"
        pagination={{
...
export default CountryOfOriginsPage
