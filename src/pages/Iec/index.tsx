...
const IecCodePage: NextPage = () => {
  ...
  // ? useQuery
  const { data, isLoading } = api.IecCode.getAll.useQuery(variables, {
    enabled: !!session
  })

  return (
    <Layout
      breadcrumbs={[{ label: 'Home', link: '/' }, { label: 'IecCode' }]}
      title="IecCode"
    >
